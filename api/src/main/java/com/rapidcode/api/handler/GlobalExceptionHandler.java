...
import static com.rapidcode.api.handler.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleDuplicateEmailException(DuplicateEmailException exp) {
        return ResponseEntity
                ...
                .body(
                        ExceptionResponse.builder()
                                .businessErrorCode(EMAIL_ALREADY_TAKEN.getCode())
                                .businessErrorDescription(EMAIL_ALREADY_TAKEN.getDescription())
                                .error(exp.getMessage())
                                .build()
                );
    }
